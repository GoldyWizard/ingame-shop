...
le = "None"
purchase = "None"
player_inventory = ["Sword", "Potion", "Axe", "Robes"]
player_equips = ["Empty"]
...
Potion = "Health", 15
Ether = "Mana", 15
weapon_values = [Sword, Axe]
armor_values = [Leather_Armor, Robes]
item_values = {"Potion":("Health", 15)}
itemequippable = dict = {"Potion":False, "Antidote":False, "Ether":False, "Arrows":False, "Sword":True, "Axe":True, "Bow":True, "Mage Staff":True, "Leather Armor":True, "Iron Chestplate":True, "Robes":True, "Gauntlets":True}
...
def player_inv():
    ...
    while inv_ck == "":
        ...
        if "Empty" in player_inventory and gp == 0 and len(player_equips) == 0:
            ...
            loc = ""
            break
        elif "Empty" not in player_inventory:
                ...
                while equip_ck == "":
                    ...
                    if equip_ck == "Nothing":
                        ...
                        while equip_ck in player_inventory:
                            ...
                            le = equip_ck
                            print('')
                            print("Would you like to equip anything else?")
                            for x in player_inventory:
                                print("|",x,"| ", end="")
                            print()
                            print('')
